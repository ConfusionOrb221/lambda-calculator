      ...
      <div className="App">
        ...
        <div className="buttons">
          <div className="leftside">
            <Specials specialState={ specialState } setSpecialState={ setSpecialState } onClick= { (event) => doSpecialStates(event) }/>
            <Numbers numberState={ numberState } setNumberState={ setNumberState } onClick={ (event) => addNumber(event) } />
          </div>
          <div className="rightside">
            <Operators operatorState={ operatorState } setOperatorState={ setOperatorState } onClick={ (event) => doOperators(event) }/>
          </div>
        </div>
      </div>
    </div>
